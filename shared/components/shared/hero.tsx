...
const Hero = () => {
  return (
      <div className="h-[400px] relative flex justify-between mt-32 p-[38px] bg-gradient-to-r from-[#7C67C9] rounded-[50px] via-purple-500 to-indigo-500 to-90%">
        ...
        <img
          className="w-[500px] bottom-[-2.5rem] right-0 h-[500px] object-cover absolute"
          src="https://alfabank.servicecdn.ru/site-upload/ba/6a/1053/main-main.png"
          loading="lazy"
          alt=""
        />
        <div className="w-full m-auto flex items-center gap-3 top-[16rem] absolute">
          <div className="w-[250px] h-[200px] p-4 relative bg-indigo-900 rounded-md bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-40 shadow-md">
          ...
          <div className="h-[200px] w-[250px] p-4 bg-indigo-900 rounded-md bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-40 shadow-md">
