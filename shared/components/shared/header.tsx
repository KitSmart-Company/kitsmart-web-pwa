...
export const Header: React.FC<Props> = ({
  ...
  return (
    <header
      className={cn(
        (className = "w-[1000px] absolute rounded-full m-auto border-b-none right-0 z-20 left-0  top-14 bg-[#622ddf] bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-40 shadow-md"),
        className
      )}
    >
